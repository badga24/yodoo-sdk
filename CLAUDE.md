...
`yodoo-sdk` (npm package `yodoo-sdk`, repo `npm_yodoo_app`) is a typed TypeScript client for the
...
`gh issue list --repo badga24/npm_yodoo_app --label api-docs-sync --state open`.
